      ...
      <div className="grid gap-10 lg:grid-cols-2">
        <div className="lg:pr-10">
          ...
          <div className="flex items-center space-x-4">
            ...
            >
              <span
                className="text-gray-600 transition-colors duration-700 hover:text-teal-700"
              >
            ...
            <Link
              ...
              passHref
            >
              <span className="text-gray-600 transition-colors duration-300 hover:text-teal-700">
